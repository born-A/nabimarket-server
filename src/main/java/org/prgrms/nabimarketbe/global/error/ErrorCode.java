...
public enum ErrorCode {
    ...
    COMPLETE_REQUEST_NOT_FOUND(HttpStatus.INTERNAL_SERVER_ERROR, "CR001", "존재하지 않는 거래 성사 요청입니다."),
    ...
    CONCURRENCY_ISSUE_GENERATE(HttpStatus.INTERNAL_SERVER_ERROR, "N0001)", "동시성 이슈가 발생했습니다.");
