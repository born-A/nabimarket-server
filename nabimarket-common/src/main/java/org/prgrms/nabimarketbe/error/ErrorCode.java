...
public enum ErrorCode {
    ...
    USER_REFRESH_TOKEN_NOT_VALID(HttpStatus.UNAUTHORIZED, "U0006", "잘못된 리프레시 토큰 서명입니다."),
    USER_TOKEN_NOT_SUPPORTED(HttpStatus.UNAUTHORIZED, "U0007", "지원하지 않는 토큰입니다."),
    USER_TOKEN_CLAIM_NULL(HttpStatus.UNAUTHORIZED, "U0008", "유저토큰의 claim이 null입니다."),
